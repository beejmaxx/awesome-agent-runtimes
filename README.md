...
![Catalog entries](https://img.shields.io/badge/entries-35-5b5bd6.svg)
...
| Project                                                                   | Stars                                                                 | Runtime fit                                                                                                                              | Stack               | Deploy                        |
| ------------------------------------------------------------------------- | --------------------------------------------------------------------: | ---------------------------------------------------------------------------------------------------------------------------------------- | ------------------- | ----------------------------- |
| [AgentScope](https://github.com/agentscope-ai/agentscope)                 | [⭐ 29,149](https://github.com/agentscope-ai/agentscope/stargazers)    | Developer framework for tool-using and multi-agent applications with runtime services. `multi-agent` `tools` `distributed`               | Python · Apache-2.0 | library, self-hosted          |
