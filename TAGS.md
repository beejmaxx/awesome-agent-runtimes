...
- [Stagehand](https://github.com/browserbase/stagehand) - Browser-agent SDK that combines natural-language actions with deterministic browser automation.

## background-jobs

- [Trigger.dev](https://github.com/triggerdotdev/trigger.dev) - TypeScript background-job platform for long-running AI tasks with retries, queues, and monitoring.
...
- [smolagents](https://github.com/huggingface/smolagents) - Compact Hugging Face agent library centered on code-executing agents and composable tools.
...
- [LlamaIndex](https://github.com/run-llama/llama_index) - Data-centric agent framework with workflows, tools, retrieval, memory, and multi-agent patterns.
...
- [Hatchet](https://github.com/hatchet-dev/hatchet) - Task orchestration platform for durable workflows, queues, retries, concurrency, and monitoring.
- [Inngest](https://github.com/inngest/inngest) - Event-driven durable execution platform for step functions, scheduling, retries, and agent workflows.
- [LangGraph](https://github.com/langchain-ai/langgraph) - Graph-based runtime for stateful, durable, and human-in-the-loop agent workflows.
...
- [OpenAI Agents SDK](https://github.com/openai/openai-agents-python) - Lightweight Python runtime for agent loops, handoffs, guardrails, sessions, and tracing.
...
- [Mastra](https://github.com/mastra-ai/mastra) - TypeScript agent framework with workflows, memory, evaluation, and observability.
